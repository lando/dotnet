---
title: Development
description: Learn how to develop and contribute to the Lando Dotnet service
---
...
* [Lando 3.21.0+](https://docs.lando.dev/basics/installation.html) preferably installed [from source](https://docs.lando.dev/getting-started/installation.html#from-source).
...
This plugin contains various working and tested Lando apps in the [examples](https://github.com/lando/dotnet/tree/main/examples) folder. You should use these or create new ones to help with plugin development.
